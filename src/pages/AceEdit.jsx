...
import g1 from "../assets/aceedit/ace1.avif";
import g2 from "../assets/aceedit/ace2.jpeg";
import g3 from "../assets/aceedit/ace3.jpeg";
import g4 from "../assets/aceedit/ace4.jpeg";
import g5 from "../assets/aceedit/ace5.png";
import g6 from "../assets/aceedit/ace6.avif";
import g7 from "../assets/aceedit/ace7.png";
import acelogo from "../assets/aceeditlogo.png";
import acevdo from "../assets/aceedit/acevdo.mp4";
...
const FEATURES = [
  {
    roman: "i",
    icon: MapPinned,
    title: "Airport Corridor Location",
    blurb:
      "Direct access to the Yamuna Expressway, minutes from the upcoming Noida International Airport at Jewar.",
  },
  {
    roman: "ii",
    icon: Star,
    ...
    blurb:
      "Contemporary architecture, premium finishes, and designed amenities that raise the bar in this micro-market.",
  },
  {
    roman: "iii",
    icon: ShieldCheck,
    ...
    blurb:
      "Fully compliant, clear documentation, transparent delivery timelines — buyer confidence built in.",
  },
  {
    roman: "iv",
    icon: TrendingUp,
    title: "Airport-Driven Appreciation",
    blurb:
      "Jewar Airport — one of Asia's largest — is set to transform the Yamuna Expressway into a premium residential corridor.",
  },
  {
    roman: "v",
    icon: Users,
    title: "Family-Ready Community",
    blurb:
      "Schools, retail and green space within the project catchment make Ace Edit a genuine end-use address.",
  },
];

const GALLERY = [
  { src: g1, caption: "Luxury Retail Atrium" },
  { src: g3, caption: "Signature Leisure Pool" },
  { src: g2, caption: "Contemporary Mixed-Use Towers" },
  { src: g7, caption: "Professional Sports Amenities" },
  { src: g5, caption: "Minimalist Luxury Suites" },
  { src: g4, caption: "High-Street Shopping Boulevard" },
  { src: g6, caption: "Designer Dining Experience" },
];
...
const CONNECTIVITY = [
  ...
  {
    label: "Metro",
    title: "Aqua Line, Greater Noida",
    note: "~12 km · operational",
  },
  {
    label: "Rail",
    title: "Mathura–Delhi Rail Corridor",
    note: "Direct train access",
  },
];
...
const WHAT_YOU_GET = [
  ...
  { label: "Possession", value: "As per schedule" },
  { label: "Ownership", value: "Leasehold · RERA Compliant" },
  { label: "Approvals", value: "RERA · Building Plan Approved" },
  { label: "Advisory", value: "Home loan & documentation support" },
];
...
const AceEdit = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F8F5F2] text-[#1A1414] selection:bg-[#873953] selection:text-white overflow-x-hidden font-sans">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-4 text-[#F8F5F2]/85 max-w-3xl">
                ...
                <p className="text-[#F8F5F2]/70 font-light text-base md:text-lg italic max-w-xl">
                  Contemporary living, airport-corridor address.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 relative">
          <div className="lg:col-span-4">
            ...
            <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] text-[#1A1414] mt-6">
              Modern residences on the
              <span className="italic text-[#873953]">
                {" "}
                Jewar growth corridor.
              </span>
            </h2>
          </div>
          <div className="lg:col-span-7 lg:col-start-6 lg:pt-3">
            <p className="text-xl leading-[1.6] text-[#1A1414]/80 font-light">
              ...
              ce Edit is a thoughtfully designed contemporary residential
              project on the Yamuna Expressway, one of India's
              fastest-appreciating corridors, anchored to the upcoming Noida
            ...
            <div className="my-10 flex items-center gap-5">
              ...
              <span className="text-[10px] tracking-[0.3em] uppercase text-[#873953] font-semibold">
                Why investors choose Ace Edit
              </span>
            </div>
            <p className="text-base leading-[1.75] text-[#1A1414]/65 font-light">
              Designed for aspirational families and smart investors, Ace Edit
              balances quality specification with strong long-term appreciation
              potential — in a location that is just reaching its inflection
              point.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 mb-16 lg:mb-20">
            ...
            <div className="lg:col-span-6 lg:col-start-7 lg:pt-3">
              <p className="text-[#1A1414]/65 font-light leading-relaxed text-lg">
                Five reasons Ace Edit resonates with both end-users looking for
                quality living and investors seeking appreciation.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-14">
            <div className="lg:col-span-6">
              ...
              <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] mt-6">
                A walk through
                <span className="italic text-[#873953]"> Ace Edit.</span>
              </h2>
            </div>
      ...
      <section
        id="location"
        className="px-6 lg:px-10 py-28 lg:py-24 bg-[#F8F5F2] relative"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            ...
            <p className="text-[#1A1414]/70 font-light leading-relaxed mb-6 text-lg">
              The Yamuna Expressway is on the cusp of transformation. The Noida
              International Airport at Jewar — one of Asia's largest greenfield
              airports — is under active construction and set to redefine this
              corridor.
            </p>
            <p className="text-[#1A1414]/60 font-light leading-relaxed">
              Ace Edit sits on this expressway today, before the airport premium
              has been fully priced into the market.
            </p>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="relative mb-10 group overflow-hidden">
              <div className=" overflow-hidden">
                <video src={acevdo} autoPlay controls muted></video>
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            ...
            <p className="text-[#1A1414]/65 text-base md:text-lg font-light mb-12 max-w-2xl mx-auto leading-relaxed">
              Our residential advisory team will share floor plans, pricing and
              payment plans. Schedule a visit to the project site at Yamuna
              Expressway.
            </p>
