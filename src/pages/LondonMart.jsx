...
import londonmart from "../assets/londonmart/lmbanner.png";
import jmLogo from "../assets/jmlogo.png";
import g1 from "../assets/londonmart/mart2.png";
import g2 from "../assets/londonmart/mart1.png";
import g3 from "../assets/londonmart/mart5.png";
import g4 from "../assets/londonmart/mart4.png";
import g5 from "../assets/londonmart/mart6.png";
import g6 from "../assets/londonmart/mart3.png";
import g7 from "../assets/londonmart/londonmart.jpg";
...
const FEATURES = [
  {
    roman: "i",
    icon: MapPinned,
    title: "Captive Catchment",
    blurb:
      "Surrounded by over half a million residents within a 3 km radius — one of NCR's densest micro-markets.",
  },
  {
    roman: "ii",
    icon: Building2,
    title: "Mixed-Use Format",
    blurb:
      "Ground-floor retail, upper-floor offices and curated F&B destinations under one roof.",
  },
  {
    roman: "iii",
    icon: ShieldCheck,
    title: "Clear Title & RERA",
    blurb:
      "Fully RERA-registered commercial spaces with clear documentation and transparent ownership.",
  },
  {
    roman: "iv",
    icon: Route,
    ...
    blurb:
      "Proposed metro extension and Noida–Greater Noida Expressway within immediate reach.",
  },
  {
    roman: "v",
    icon: TrendingUp,
    title: "Rental Demand",
    blurb:
      "High occupancy demand driven by the surrounding residential population and corporate expansion into NCR West.",
  },
];

const GALLERY = [
  { src: g1, caption: "Grand Luxury Shopping Atrium" },
  { src: g7, caption: "European-Inspired Retail Facade" },
  { src: g3, caption: "Integrated Retail Floor Planning" },
  { src: g2, caption: "Iconic Landmark Commercial Tower" },
  { src: g5, caption: "Premium Plaza & Circulation Design" },
  { src: g4, caption: "Boutique Fashion Experience" },
  { src: g6, caption: "Vibrant Lifestyle Dining Court" },
];

const CONNECTIVITY = [
  {
    label: "Metro",
    title: "Aqua Line Extension",
    note: "Proposed · under planning",
  },
  {
    label: "Road",
  ...
  },
  {
    ...
    note: "~40 km · under construction",
  },
  {
    label: "NH",
    title: "NH-09 National Highway",
    note: "Direct access",
  },
];

const WHAT_YOU_GET = [
  { label: "Format", value: "Retail + F&B + Office" },
  { label: "Unit Sizes", value: "On request" },
  { label: "Status", value: "Available" },
  { label: "Ownership", value: "Freehold · RERA Registered" },
  { label: "Approvals", value: "RERA · OC Applied" },
  { label: "Advisory", value: "Leasing & sale advisory included" },
];
...
const LondonMart = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#F8F5F2] text-[#1A1414] selection:bg-[#873953] selection:text-white overflow-x-hidden font-sans">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-8 gap-y-4 text-[#F8F5F2]/85 max-w-3xl">
                ...
                <p className="text-[#F8F5F2]/70 font-light text-base md:text-lg italic max-w-xl">
                  NCR's most connected commercial address.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 relative">
          <div className="lg:col-span-4">
            ...
            <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] text-[#1A1414] mt-6">
              A modern commercial destination in
              <span className="italic text-[#873953]">
                {" "}
                NCR's fastest corridor.
              </span>
            </h2>
          </div>
          <div className="lg:col-span-7 lg:col-start-6 lg:pt-3">
            <p className="text-xl leading-[1.6] text-[#1A1414]/80 font-light">
              ...
              Ondon Mart is a premium mixed-use commercial complex designed for
              retail, F&B and office occupiers in Greater Noida West — the most
              aggressively growing residential micro-market in the National
              Capital Region.
            </p>
            ...
            <p className="text-base leading-[1.75] text-[#1A1414]/65 font-light">
              With a catchment of over half a million residents within a
              three-kilometre radius and seamless metro connectivity on the way,
              London Mart positions itself as the commercial spine of an
              emerging urban neighbourhood.
            </p>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 mb-16 items-center lg:mb-20">
            <div className="lg:col-span-5">
              <SectionLabel label="Key Features" />
              <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] text-[#1A1414] mt-6">
                Designed for
                <span className="italic text-[#873953]"> commerce.</span>
              </h2>
            </div>
            <div className="lg:col-span-6 lg:col-start-7 lg:pt-3">
              <p className="text-[#1A1414]/65 font-light leading-relaxed text-lg">
                Five reasons London Mart is the address discerning retail, F&B
                and office occupiers choose first.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-14">
            <div className="lg:col-span-6">
              ...
              <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] mt-6">
                A walk through
                <span className="italic text-[#873953]"> London Mart.</span>
              </h2>
            </div>
      ...
      <section
        id="location"
        className="px-6 lg:px-10 py-28 lg:pt-40 lg:pb-28 bg-[#F8F5F2] relative"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            ...
            <h2 className="font-serif text-4xl lg:text-5xl leading-[1.05] text-[#1A1414] mt-6 mb-8">
              A commercial hub where
              <span className="italic text-[#873953]"> NCR grows next.</span>
            </h2>
            <p className="text-[#1A1414]/70 font-light leading-relaxed mb-6 text-lg">
              Greater Noida West is the single fastest-growing micro-market in
              the National Capital Region — with over two lakh apartment units
              delivered and hundreds of thousands more under construction.
            </p>
            <p className="text-[#1A1414]/60 font-light leading-relaxed">
              London Mart sits at the nerve centre of this growth, positioned to
              become the default commercial address for an entire neighbourhood.
            </p>
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-16 lg:mb-20">
            ...
            <h2 className="font-serif text-4xl lg:text-6xl leading-[1.05] max-w-3xl mx-auto mt-6">
              Clear ownership,
              <span className="italic text-[#873953]"> clear returns.</span>
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          >
            ...
            <p className="text-[#1A1414]/65 text-base md:text-lg font-light mb-12 max-w-2xl mx-auto leading-relaxed">
              Our leasing and investment advisory team will walk you through
              available units, rentals, and fit-out timelines. Book a site tour
              today.
            </p>
